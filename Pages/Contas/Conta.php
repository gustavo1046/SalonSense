        ...
        <div class="container">
            ...
            <?php
                ...
                foreach($result as $agenda):
                    ...
                    echo "<div class='item'>";
                    echo "<button class='button_agenda' onclick='showModal(".$agenda->getId().", \"".$agenda->getNome_cliente()."\", \"".$data."\", \"".$hora_inicio."\", \"".$hora_fim."\", \"".$agenda->getValor()."\", \"".$agenda->getServico()."\", \"".$agenda->getFormaPagamento()."\")'>".$agenda->getNome_cliente()." | ".$data." | R$".$agenda->getValor()."</button>";
                    echo "</div>";
                endforeach;    
                echo "</div>";
                echo "Renda Liquida no período: R$: ".$soma;
            ?>
            <br><a href="../Home Page/HomePage.php" id="voltar">Voltar</a>
        </div>
    </main>
